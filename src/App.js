    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          <img src="https://images.unsplash.com/photo-1620288627223-53302f4e8c74?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Mzk2MDh8MHwxfHNlYXJjaHwxfHxGcm9zY2lhJTJCTG9nbyUyQkxvYWRpbmd8ZW58MHx8fHwxNzQ3OTg3NjEwfDA&ixlib=rb-4.1.0&q=80&w=1080" alt="Froscia Logo Loading" />
          <div className="mt-4">
